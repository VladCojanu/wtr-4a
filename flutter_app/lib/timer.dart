...
class TimerPageState extends State<TimerPage> {
  ...
  Widget buildFloatingButton(String text, VoidCallback callback, int button) {
        ...
        new Expanded(
          ...
          child: new Padding(
            ...
            child: new Row(
              ...
              children: <Widget>[
                buildFloatingButton(dependencies.stopwatch.isRunning ? "lap" : "reset", leftButtonPressed, 1),
                buildFloatingButton(dependencies.stopwatch.isRunning ? "stop" : "start", rightButtonPressed, 2),
              ],
            ),
          ),
        ),
